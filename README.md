<div align="center">
  ...
  **Adaptive Pharmacokinetic Model Discovery Engine**
  ...
  [![Tests](https://img.shields.io/badge/tests-1828%20collected-success)]()
  <!-- apmode:/AUTO:badge_tests -->
...
```bash
uv run pytest tests/ -q                         # <!-- apmode:AUTO:tests -->1828<!-- apmode:/AUTO:tests --> collected
uv run pytest tests/ -q -m "not live"           # <!-- apmode:AUTO:tests_nonlive -->1811<!-- apmode:/AUTO:tests_nonlive --> skip live LLM tests
...
**<!-- apmode:AUTO:tests -->1828<!-- apmode:/AUTO:tests --> tests collected** (<!-- apmode:AUTO:tests_nonlive -->1811<!-- apmode:/AUTO:tests_nonlive --> non-live) across multiple strategies — all counts auto-synced by `scripts/sync_readme.py`:
...
```
<!-- apmode:AUTO:tests -->1828<!-- apmode:/AUTO:tests -->
```
