...
# ---------------------------------------------------------------------------
# Bundle fixture helpers (shared with the ``graph`` / ``lineage`` CLI tests
# relocated here from the former ``test_cli.py``)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# `graph` command (relocated from test_cli.py::TestGraph)
# ---------------------------------------------------------------------------
