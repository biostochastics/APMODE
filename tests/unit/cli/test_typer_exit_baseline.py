...
# add the parent directory before importing. ``FIXTURES_DIR`` is
# ``tests/fixtures`` regardless of this module's depth, so
# ``FIXTURES_DIR.parent.parent`` is the repo root — stable across moves.
