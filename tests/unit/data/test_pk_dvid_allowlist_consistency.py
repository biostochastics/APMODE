...
class TestPKDVIDAllowlistConsistency:
    ...
    def test_adapters_public_alias_matches_underscored(self) -> None:
        ...
        # an import on the underscored name before promotion. It is an
        # ALIAS (same object), not merely an equal copy — a refactor that
        # rebinds one name to a fresh set must trip this identity check.
        assert _PK_DVID_ALLOWLIST is PK_DVID_ALLOWLIST
