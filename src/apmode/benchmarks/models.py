...
class BenchmarkCase(BaseModel):
    ...
    # Suite C: literature-benchmark comparators. Suite C compares APMODE
    # against published, peer-reviewed reference parameterizations. Blinded
    # human-expert panel baselines are external-collaborator inputs rather
    # than hard-coded fixtures here.
